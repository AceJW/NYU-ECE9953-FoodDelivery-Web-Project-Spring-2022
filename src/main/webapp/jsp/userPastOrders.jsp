...
// 			if(username == null) username = "tom";
			...
			while(rs!= null && rs.next()) {	
				...
				if(status.equals("waiting")) {
					%>
					<form method="post" action="deleteOrder.jsp?username=<%=username%>&id=<%=id%>">
						<tr>
							...
							<td class="text-right">
								...
								<button class="button alert tiny">Cancel</button>			
							</td>
						</tr>
					</form>
					<%} 
						...
						%>
						<form method="post" action="receiveOrder.jsp?username=<%=username%>&id=<%=id%>">
							<tr>
								...
								<td class="text-right">
									<!-- <button class="button tiny">View User</button> -->
									<button class="button alert tiny">Received</button>			
								</td>
							</tr>
						</form>
						<%} else {%>
