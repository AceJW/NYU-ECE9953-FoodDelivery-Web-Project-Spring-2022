  ...
  <h2>
	...
	<table class="table table-striped table-hover user-list fixed-header">
		...
		try {
			...
			String query = "SELECT * FROM demo.reservation where restaurantName = (select restaurantName FROM demo.restaurant where username='"+username+"')";
