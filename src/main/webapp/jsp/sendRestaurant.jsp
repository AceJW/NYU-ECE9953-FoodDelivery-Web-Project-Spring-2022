...
<body>
	...
	try {
		...
		String insert = "INSERT INTO `demo`.`restaurant` (`restaurantName`, `username`, `categories`, `address`, `city`, `country`,  `rate`, `createTime`)"
				+"VALUES (?, ?, ?, ?, ?, ?, ?, ?)";
		...
		String update = "UPDATE `demo`.`users` SET `role` = 'seller' WHERE `username` = '"+username+"'";
	...
	<div class="payment-success-popup page--popup" id="payment-success">
	  ...
	  <p class="popup--subtitle">Your Application is posted</p>
