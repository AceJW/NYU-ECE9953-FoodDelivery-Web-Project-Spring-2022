			...
			<div class="row justify-content-center">
				<div class="col-lg-5">
					...
					<div class="text-center add_bottom_15">
						<h4>Please fill the Reservation form below</h4>
						<p>Restaurant <%out.print(restaurantName);%></p>
					</div>	
					<form method="post" action="jsp/sendReservation.jsp?username=<%=username%>&restaurantName=<%=restaurantName%>">
						<!-- /row -->
						...
						<!-- /row -->
						<button class="btn_1 gradient" type="submit">Reserve Now!</button>
					</form>
