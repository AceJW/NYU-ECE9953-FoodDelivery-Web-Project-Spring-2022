...
<body>
    ...
    <header class="header_in clearfix">
        <div class="container">
            <div id="logo"><a href="sellerDashboard.jsp?username=<%=username%>"><img src="img/logo_sticky.svg" width="140" height="35" alt=""></a></div>
            ...
            <div class="row justify-content-center">
                <div class="col-xl-6 col-lg-8">
                    <div class="box_order_form">
                        ...
                        <form action="jsp/storeFood.jsp" method="get">
                        <%request.getSession().setAttribute("username", username);%>
                        <%request.getSession().setAttribute("restaurantName", restaurantName);%>
	                        <div class="main">
	                            <div class="form-group"><label>Food Name</label><input class="form-control"
	                                    placeholder="Food Name" name = "foodName" required></div>	                               
	                            <div class="form-group"><label>Price</label><input class="form-control"
	                                    placeholder="Price" name = "price" required></div>                            
	                            <div class="form-group"><label>Food Type</label><input class="form-control"
	                                    placeholder="Food Type" name = "foodType" required></div>
	                            <div class="form-group"><label>Description</label><input class="form-control"
	                                    placeholder="Description" name = "description" required></div>        
